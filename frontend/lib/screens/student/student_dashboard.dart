        ...
        children: [
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(color: AppColors.accent.withOpacity(0.5), blurRadius: 12),
                    ],
                  ),
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Text('Notice Board', style: GoogleFonts.poppins(fontSize: 9, color: AppColors.textMuted)),
                  ]),
                ),
              ],
            ),
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                _navItem(icon: Icons.home_rounded, label: 'All Notices', value: 'all'),
                _navItem(icon: Icons.priority_high_rounded, label: 'Important', value: 'important'),
                _navExpandable(
                ...
                _navItem(icon: Icons.bookmark_rounded, label: 'Bookmarks', value: 'bookmarks'),
                _navItem(icon: Icons.history_rounded, label: 'Expired', value: 'expired'),
              ],
            ),
          ),
            ...
            child: InkWell(
              ...
              child: Padding(
                ...
                child: Row(children: [
                  ...
                  const SizedBox(width: 10),
                  Text('Logout', style: GoogleFonts.poppins(fontSize: 13, color: Colors.white70, fontWeight: FontWeight.w500)),
                ]),
              ),
            ),
          ),
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: isSelected
              ? [BoxShadow(color: AppColors.accent.withOpacity(0.15), blurRadius: 8)]
              : null,
        ),
        child: Row(
          children: [
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(label,
                style: GoogleFonts.poppins(fontSize: 13, color: Colors.white60, fontWeight: FontWeight.w400),
              ),
            ),
            Icon(
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: Text('Student', style: GoogleFonts.poppins(fontSize: 11, fontWeight: FontWeight.w600, color: Colors.white)),
          ),
