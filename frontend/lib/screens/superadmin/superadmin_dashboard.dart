    ...
    return Container(
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          ...
          colors: [Color(0xFF0A0E3F), Color(0xFF1A237E), Color(0xFF0288D1)],
          stops: [0.0, 0.55, 1.0],
        ),
        boxShadow: [
          BoxShadow(color: Colors.black.withOpacity(0.4), blurRadius: 20, offset: const Offset(0, 6)),
          BoxShadow(color: const Color(0xFF00E5FF).withOpacity(0.1), blurRadius: 30, offset: const Offset(0, 2)),
        ],
      ),
      child: SafeArea(
        bottom: false,
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(color: const Color(0xFF00E5FF).withOpacity(0.4), blurRadius: 14, offset: const Offset(0, 4)),
                  ],
